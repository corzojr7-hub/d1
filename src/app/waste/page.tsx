  ...
  return (
    <div className="mx-auto max-w-md px-4 py-8">
      ...
      <div className="mt-6 mb-2 space-y-3">
        ...
        <Link 
          href="/waste/evidence" 
          className="w-full flex items-center justify-between bg-slate-50 border border-slate-200 text-slate-800 p-4 rounded-2xl shadow-sm hover:bg-slate-100 transition-all active:scale-[0.98]"
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h2 className="font-bold text-sm">Descargar Evidencias (ZIP)</h2>
              <p className="text-[11px] text-slate-500 font-medium mt-0.5">Descarga todas las fotos de averías y calidad</p>
            </div>
          </div>
